...
def head_to_head_laptime(driverIDs, season, round_number, startLap = 0, endLap = None, laps = 0):
	...
	if laps > 0:
		...
		deltaTimes = APIRequests.get_laps(season, round_number, driverIDs[0])[startLap:endLap]
